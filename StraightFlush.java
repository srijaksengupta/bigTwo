...
/**
 * The StraightFlush class is a subclass of the Hand class, and is used to model a hand of StraightFlush in a Big Two game.
...
public class StraightFlush extends Hand implements ITF
{
	private static final long serialVersionUID = -1000L;
	
	/**
	 * This is a constructor for building a hand of straight flush with the specified player and list of cards.
	 * 
	...
	/**
	 * This is an overridden method for retrieving the top card of this hand of straight flush.
	 * 
	 * @return The top card of this hand of straight flush
	 *
	 */
	...
	/**
	 * This is an overridden method for checking if this hand of straight flush is a valid hand.
	 * 
	 * @return Whether the hand of straight flush is valid
	 *
	 */
	...
	public boolean isValid()
	{
		...
		//Checking whether all the cards are of the same suit
	...
	/**
	 * This is an overridden method for returning a string specifying the type of this hand of straight flush.
	 * 
	 * @return A string specifying the type this hand of straight flush
	 *
	 */
